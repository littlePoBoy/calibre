...
class BasicNewsRecipe(Recipe):
    ...
    def fetch_obfuscated_article(self, url, dir, f, a, num_of_feeds):
        print('fetch_obfuscated_article', url)
    ...
    def fetch_embedded_article(self, article, dir, f, a, num_of_feeds):
        print('fetch_embedded_article', article)
    ...
    def build_index(self):
        ...
        for f, feed in enumerate(feeds):
            ...
            for a, article in enumerate(feed):
                ...
                req = WorkRequest(func, (arg, art_dir, f, a, len(feed)),{}, (f, a), self.article_downloaded,self.error_in_article_download)
                req.feed = feed
                req.article = article
    ...
    def article_downloaded(self, request, result):
        ...
        self.log.info('Downloaded article:', article.title, 'from', article.url)
