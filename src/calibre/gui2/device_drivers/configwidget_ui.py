# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\device_drivers\configwidget.ui'
#
...
class Ui_ConfigWidget(object):
    def setupUi(self, ConfigWidget):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=ConfigWidget)
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.columns = QtWidgets.QListWidget(parent=self.groupBox)
        ...
        self.column_up = QtWidgets.QToolButton(parent=self.groupBox)
        ...
        self.column_down = QtWidgets.QToolButton(parent=self.groupBox)
        ...
        self.label = QtWidgets.QLabel(parent=ConfigWidget)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 4, 0, 1, 1)
        self.opt_save_template = QtWidgets.QLineEdit(parent=ConfigWidget)
