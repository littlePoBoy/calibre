# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\catalog\catalog_bibtex.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.bibfile_enc = QtWidgets.QComboBox(parent=Form)
        self.bibfile_enc.setObjectName("bibfile_enc")
        self.gridLayout.addWidget(self.bibfile_enc, 1, 0, 1, 1)
        self.db_fields = QtWidgets.QListWidget(parent=Form)
        ...
        self.bibfile_enctag = QtWidgets.QComboBox(parent=Form)
        ...
        self.bib_cit = QtWidgets.QLineEdit(parent=Form)
