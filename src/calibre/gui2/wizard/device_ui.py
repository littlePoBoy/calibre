# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\wizard\device.ui'
#
...
class Ui_WizardPage(object):
    def setupUi(self, WizardPage):
        ...
        self.label = QtWidgets.QLabel(parent=WizardPage)
        self.label.setText("")
        self.label.setWordWrap(True)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 2)
        self.groupBox = QtWidgets.QGroupBox(parent=WizardPage)
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.manufacturer_view = QtWidgets.QListView(parent=self.groupBox)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=WizardPage)
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.groupBox_2)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.device_view = QtWidgets.QListView(parent=self.groupBox_2)
