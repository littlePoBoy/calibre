# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\preferences\look_feel.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_7 = QtWidgets.QGridLayout(self.main_interface_tab)
        ...
        self.gridLayout_7.addWidget(self.label_widget_style, 0, 0, 1, 1)
        self.opt_ui_style = QtWidgets.QComboBox(parent=self.main_interface_tab)
        self.opt_ui_style.setObjectName("opt_ui_style")
        self.gridLayout_7.addWidget(self.opt_ui_style, 0, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.icon_theme, 1, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.icon_theme_button, 1, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_color_palette_label, 2, 0, 1, 1)
        self.button_adjust_colors = QtWidgets.QPushButton(parent=self.main_interface_tab)
        self.button_adjust_colors.setObjectName("button_adjust_colors")
        self.gridLayout_7.addWidget(self.button_adjust_colors, 2, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_gui_layout, 3, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_language, 4, 1, 1, 1)
        self.label_6 = QtWidgets.QLabel(parent=self.main_interface_tab)
        self.label_6.setObjectName("label_6")
        self.gridLayout_7.addWidget(self.label_6, 5, 0, 1, 1)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.opt_cover_corner_radius = QtWidgets.QSpinBox(parent=self.main_interface_tab)
        self.opt_cover_corner_radius.setObjectName("opt_cover_corner_radius")
        self.horizontalLayout_3.addWidget(self.opt_cover_corner_radius)
        self.opt_cover_corner_radius_unit = QtWidgets.QComboBox(parent=self.main_interface_tab)
        self.opt_cover_corner_radius_unit.setObjectName("opt_cover_corner_radius_unit")
        self.horizontalLayout_3.addWidget(self.opt_cover_corner_radius_unit)
        self.gridLayout_7.addLayout(self.horizontalLayout_3, 5, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_systray_icon, 6, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_disable_animations, 6, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_disable_tray_notification, 7, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_show_splash_screen, 7, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_book_list_tooltips, 8, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_show_layout_buttons, 8, 1, 1, 1)
        ...
        self.gridLayout_7.addLayout(self.horizontalLayout, 9, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.change_font_button, 9, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.label_4, 11, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_book_list_extra_row_spacing, 11, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.opt_row_numbers_in_book_list, 12, 0, 1, 1)
        ...
        self.gridlayout_22.addWidget(self.opt_show_avg_rating, 0, 0, 1, 1)
        self.opt_show_links_in_tag_browser = QtWidgets.QCheckBox(parent=self.tb_tab1)
        self.opt_show_links_in_tag_browser.setChecked(True)
        self.opt_show_links_in_tag_browser.setObjectName("opt_show_links_in_tag_browser")
        self.gridlayout_22.addWidget(self.opt_show_links_in_tag_browser, 0, 1, 1, 1)
        ...
        self.gridlayout_22.addWidget(self.opt_tag_browser_show_tooltips, 0, 2, 1, 1)
        ...
        self.gridlayout_22.addWidget(self.opt_tag_browser_show_counts, 1, 0, 1, 1)
        self.opt_show_notes_in_tag_browser = QtWidgets.QCheckBox(parent=self.tb_tab1)
        self.opt_show_notes_in_tag_browser.setChecked(True)
        self.opt_show_notes_in_tag_browser.setObjectName("opt_show_notes_in_tag_browser")
        self.gridlayout_22.addWidget(self.opt_show_notes_in_tag_browser, 1, 1, 1, 1)
        ...
        self.gridlayout_22.addWidget(self.opt_tag_browser_old_look, 1, 2, 1, 1)
        ...
        self.gridlayout_22.addWidget(self.opt_tag_browser_hide_empty_categories, 2, 0, 1, 1)
        self.opt_icons_on_right_in_tag_browser = QtWidgets.QCheckBox(parent=self.tb_tab1)
        self.opt_icons_on_right_in_tag_browser.setChecked(True)
        self.opt_icons_on_right_in_tag_browser.setObjectName("opt_icons_on_right_in_tag_browser")
        self.gridlayout_22.addWidget(self.opt_icons_on_right_in_tag_browser, 2, 1, 1, 1)
        ...
        self.gridlayout_22.addWidget(self.opt_tag_browser_always_autocollapse, 2, 2, 1, 1)
        self.verticalLayout_42.addLayout(self.gridlayout_22, 5, 0, 1, 3)
        ...
        self.gridLayout_11.addWidget(self.opt_cb_fullscreen, 0, 1, 1, 2)
        ...
        self.gridLayout_11.addWidget(self.opt_cover_flow_queue_length, 7, 1, 1, 2)
        self.label_61 = QtWidgets.QLabel(parent=self.cover_browser_tab)
        self.label_61.setObjectName("label_61")
        self.gridLayout_11.addWidget(self.label_61, 7, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.cover_browser_title_template_button, 8, 2, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.opt_cover_browser_title_template, 8, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.opt_cover_browser_reflections, 4, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.opt_cb_preserve_aspect_ratio, 4, 1, 1, 2)
        self.label_987 = QtWidgets.QLabel(parent=self.cover_browser_tab)
        self.label_987.setObjectName("label_987")
        self.gridLayout_11.addWidget(self.label_987, 6, 0, 1, 1)
        self.opt_cover_browser_narrow_view_position = QtWidgets.QComboBox(parent=self.cover_browser_tab)
        self.opt_cover_browser_narrow_view_position.setObjectName("opt_cover_browser_narrow_view_position")
        self.gridLayout_11.addWidget(self.opt_cover_browser_narrow_view_position, 6, 1, 1, 2)
        ...
        self.gridLayout_11.addWidget(self.opt_cover_browser_subtitle_field, 9, 1, 1, 2)
        ...
        self.gridLayout_11.addWidget(self.fs_help_msg, 1, 1, 1, 2)
        self.label_26 = QtWidgets.QLabel(parent=self.cover_browser_tab)
        self.label_26.setObjectName("label_26")
        self.gridLayout_11.addWidget(self.label_26, 10, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.opt_books_autoscroll_time, 10, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.opt_cb_double_click_to_activate, 5, 0, 1, 2)
        ...
        self.opt_color_palette_label.setBuddy(self.button_adjust_colors)
        self.label_17.setBuddy(self.opt_gui_layout)
        self.label_7.setBuddy(self.opt_language)
        self.label_6.setBuddy(self.opt_cover_corner_radius)
        ...
        self.label_61.setBuddy(self.opt_cover_flow_queue_length)
        self.label_987.setBuddy(self.opt_cover_browser_narrow_view_position)
    ...
    def retranslateUi(self, Form):
        ...
        self.opt_color_palette_label.setText(_("User interface &colors:"))
        self.button_adjust_colors.setText(_("Adjust &colors"))
        self.label_17.setText(_("&User interface layout:"))
        self.label_7.setText(_("Choose &language (needs restart):"))
        self.label_6.setText(_("&Round the corners of covers:"))
        self.opt_cover_corner_radius.setToolTip(_("Round the corners of covers in many places they are displayed such as the Cover grid, Book details panel, etc. Adjust the amount of rounding with this setting. A value of between 5 and 10 looks good with most covers sizes. Zero disables rounding and is the default."))
        self.opt_cover_corner_radius.setSpecialValueText(_("no rounding"))
        self.opt_cover_corner_radius_unit.setToolTip(_("The unit for the cover corner rounding. Either pixel values or as a percentage of the cover size."))
        ...
        self.opt_show_layout_buttons.setText(_("Show &layout buttons in the status bar"))
...
"structure and you want to use the same column order for each one.</p>"))
        ...
        self.opt_show_avg_rating.setToolTip(_("Show the average rating per item indication in the Tag browser"))
        self.opt_show_avg_rating.setText(_("Show &average ratings"))
        self.opt_show_links_in_tag_browser.setToolTip(_("Show an icon if the item has an attached link"))
        self.opt_show_links_in_tag_browser.setText(_("Show &links icons"))
...
"see the counts by hovering your mouse over any item.</p>"))
        ...
        self.opt_show_notes_in_tag_browser.setToolTip(_("Show an icon if the item has an attached note"))
        self.opt_show_notes_in_tag_browser.setText(_("Show &notes icons"))
...
"box will cause these empty categories to be hidden.</p>"))
        ...
        self.opt_icons_on_right_in_tag_browser.setToolTip(_("If checked the notes and links icons will be placed at the right, after\n"
...
"to the left of the count and not in columns."))
        self.opt_icons_on_right_in_tag_browser.setText(_("Place icons on the &right, in columns"))
...
"that don\'t have children.</p>"))
        ...
        self.label_61.setText(_("&Number of covers to show in browse mode (needs restart):"))
...
"them to all have the same width and height"))
        ...
        self.label_987.setText(_("Cover browser &position in the narrow layout:"))
