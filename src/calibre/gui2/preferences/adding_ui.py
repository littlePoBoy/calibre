# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\preferences\adding.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_read_file_metadata = QtWidgets.QCheckBox(parent=self.tab)
        ...
        self.opt_mark_new_books = QtWidgets.QCheckBox(parent=self.actions_tab)
        ...
        self.line_2 = QtWidgets.QFrame(parent=self.actions_tab)
        self.line_2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_2.setObjectName("line_2")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.line_2)
        self.opt_preserve_date_on_ctl = QtWidgets.QCheckBox(parent=self.actions_tab)
        ...
        self.opt_check_for_dupes_on_ctl = QtWidgets.QCheckBox(parent=self.actions_tab)
        ...
        self.line = QtWidgets.QFrame(parent=self.actions_tab)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.line)
        self.opt_manual_add_auto_convert = QtWidgets.QCheckBox(parent=self.actions_tab)
        ...
        self.opt_auto_convert_same_fmt = QtWidgets.QCheckBox(parent=self.actions_tab)
        ...
        self.line_3 = QtWidgets.QFrame(parent=self.actions_tab)
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.line_3)
        self.opt_add_formats_to_existing = QtWidgets.QCheckBox(parent=self.actions_tab)
        ...
        self.opt_automerge = QtWidgets.QComboBox(parent=self.actions_tab)
        ...
        self.opt_new_book_tags = QtWidgets.QLineEdit(parent=self.actions_tab)
        ...
        self.line_7 = QtWidgets.QFrame(parent=self.actions_tab)
        ...
        self.line_8 = QtWidgets.QFrame(parent=self.actions_tab)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.actions_tab)
        self.label_5.setObjectName("label_5")
        self.formLayout_2.setWidget(14, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_5)
        self.tag_map_rules_button = QtWidgets.QPushButton(parent=self.actions_tab)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.actions_tab)
        self.label_7.setObjectName("label_7")
        self.formLayout_2.setWidget(15, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_7)
        self.author_map_rules_button = QtWidgets.QPushButton(parent=self.actions_tab)
        ...
        self.opt_auto_add_everything = QtWidgets.QCheckBox(parent=self.tab_4)
        ...
        self.auto_add_browse_button = QtWidgets.QToolButton(parent=self.tab_4)
        ...
        self.opt_auto_add_auto_convert = QtWidgets.QCheckBox(parent=self.tab_4)
        ...
        self.opt_blocked_auto_formats = QtWidgets.QListWidget(parent=self.groupBox)
        ...
        self.opt_auto_add_check_for_duplicates = QtWidgets.QCheckBox(parent=self.tab_4)
