# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\preferences\columns.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_columns = TableWidgetWithMoveByKeyPress(parent=Form)
        ...
        self.column_up = QtWidgets.QToolButton(parent=Form)
        ...
        self.del_custcol_button = QtWidgets.QToolButton(parent=Form)
        ...
        self.add_custcol_button = QtWidgets.QToolButton(parent=Form)
        ...
        self.edit_custcol_button = QtWidgets.QToolButton(parent=Form)
        ...
        self.column_down = QtWidgets.QToolButton(parent=Form)
        ...
        self.add_col_button = QtWidgets.QPushButton(parent=Form)
        self.add_col_button.setIcon(icon2)
        self.add_col_button.setObjectName("add_col_button")
        self.horizontalLayout.addWidget(self.add_col_button)
        ...
        self.hide_all_button = QtWidgets.QPushButton(parent=Form)
        self.hide_all_button.setObjectName("hide_all_button")
        self.horizontalLayout.addWidget(self.hide_all_button)
    ...
    def retranslateUi(self, Form):
        ...
        self.show_all_button.setText(_("&Show all"))
        self.hide_all_button.setText(_("&Hide all"))
