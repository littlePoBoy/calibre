# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\preferences\plugins.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.search = SearchBox2(parent=Form)
        self.search.setObjectName("search")
        self.horizontalLayout.addWidget(self.search)
        self.next_button = QtWidgets.QPushButton(parent=Form)
        ...
        self.previous_button = QtWidgets.QPushButton(parent=Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.user_installed_plugins = QtWidgets.QCheckBox(parent=Form)
        ...
        self.plugin_view = QtWidgets.QTreeView(parent=Form)
        ...
        self.toggle_plugin_button = QtWidgets.QPushButton(parent=Form)
        self.toggle_plugin_button.setObjectName("toggle_plugin_button")
        self.horizontalLayout_6.addWidget(self.toggle_plugin_button)
        self.customize_plugin_button = QtWidgets.QPushButton(parent=Form)
        ...
        self.remove_plugin_button = QtWidgets.QPushButton(parent=Form)
        ...
        self.button_plugin_new = QtWidgets.QPushButton(parent=Form)
        ...
        self.button_plugin_updates = QtWidgets.QPushButton(parent=Form)
        ...
        self.button_plugin_add = QtWidgets.QPushButton(parent=Form)
