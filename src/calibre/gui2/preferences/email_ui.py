# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\preferences\email.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.email_view = QtWidgets.QTableView(parent=Form)
        ...
        self.email_add = QtWidgets.QToolButton(parent=Form)
        ...
        self.email_make_default = QtWidgets.QPushButton(parent=Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.email_remove = QtWidgets.QToolButton(parent=Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.opt_add_comments_to_email = QtWidgets.QCheckBox(parent=Form)
        ...
        self.send_email_widget = SendEmail(parent=Form)
