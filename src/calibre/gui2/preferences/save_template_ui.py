# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\preferences\save_template.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.help_label = QtWidgets.QLabel(parent=self.groupBox)
        ...
        self.template_variables = QtWidgets.QTextBrowser(parent=self.groupBox)
        self.template_variables.setObjectName("template_variables")
        self.gridLayout_2.addWidget(self.template_variables, 3, 0, 1, 2)
        self.opt_template = HistoryBox(parent=self.groupBox)
        ...
        self.open_editor = QtWidgets.QPushButton(parent=self.groupBox)
