# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\dialogs\metadata_bulk.ui'
#
...
class Ui_MetadataBulkDialog(object):
    def setupUi(self, MetadataBulkDialog):
        ...
        self.central_widget = QtWidgets.QTabWidget(parent=MetadataBulkDialog)
        ...
        self.auto_author_sort = QtWidgets.QCheckBox(parent=self.btab)
        self.auto_author_sort.setObjectName("auto_author_sort")
        self.horizontalLayout_2.addWidget(self.auto_author_sort)
        self.swap_title_and_author = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.label_8 = QtWidgets.QLabel(parent=self.btab)
        ...
        self.author_sort = EnLineEdit(parent=self.btab)
        ...
        self.label_6 = QtWidgets.QLabel(parent=self.btab)
        ...
        self.tags = EditWithComplete(parent=self.btab)
        self.tags.setObjectName("tags")
        self.gridLayout.addWidget(self.tags, 5, 1, 1, 1)
        self.tag_editor_button = QtWidgets.QToolButton(parent=self.btab)
        ...
        self.series = EditWithComplete(parent=self.btab)
        ...
        self.clear_series = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.autonumber_series = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.series_numbering_restarts = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.series_start_number = QtWidgets.QDoubleSpinBox(parent=self.btab)
        ...
        self.series_increment = QtWidgets.QDoubleSpinBox(parent=self.btab)
        ...
        self.label_10 = QtWidgets.QLabel(parent=self.btab)
        ...
        self.apply_adddate = QtWidgets.QCheckBox(parent=self.btab)
        self.apply_adddate.setObjectName("apply_adddate")
        self.gridLayout.addWidget(self.apply_adddate, 9, 2, 1, 1)
        self.label_9 = QtWidgets.QLabel(parent=self.btab)
        ...
        self.apply_pubdate = QtWidgets.QCheckBox(parent=self.btab)
        self.apply_pubdate.setObjectName("apply_pubdate")
        self.gridLayout.addWidget(self.apply_pubdate, 10, 2, 1, 1)
        self.label_11 = QtWidgets.QLabel(parent=self.btab)
        ...
        self.languages = LanguagesEdit(parent=self.btab)
        self.languages.setObjectName("languages")
        self.gridLayout.addWidget(self.languages, 11, 1, 1, 1)
        self.clear_languages = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.casing_algorithm = QtWidgets.QComboBox(parent=self.btab)
        ...
        self.restore_original = QtWidgets.QCheckBox(parent=self.btab)
        self.restore_original.setObjectName("restore_original")
        self.gridLayout_2.addWidget(self.restore_original, 0, 2, 1, 1)
        self.remove_conversion_settings = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.change_title_to_title_case = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.update_title_sort = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.compress_cover_images = QtWidgets.QCheckBox(parent=self.btab)
        ...
        self.compress_quality = QtWidgets.QSpinBox(parent=self.btab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.button_config_cover_gen = QtWidgets.QPushButton(parent=self.btab)
        ...
        self.comments_button = QtWidgets.QPushButton(parent=self.btab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tabWidgetPage3.setGeometry(QtCore.QRect(0, 0, 729, 429))
        ...
        self.s_r_heading = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        ...
        self.filler = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.filler.setText("")
        self.filler.setObjectName("filler")
        self.vargrid.addWidget(self.filler, 1, 0, 1, 1)
        self.line = QtWidgets.QFrame(parent=self.tabWidgetPage3)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.vargrid.addWidget(self.line, 2, 0, 1, 3)
        self.xlabel_22 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.xlabel_22.setObjectName("xlabel_22")
        self.vargrid.addWidget(self.xlabel_22, 3, 0, 1, 1)
        self.query_field = QtWidgets.QComboBox(parent=self.tabWidgetPage3)
        ...
        self.save_button = QtWidgets.QPushButton(parent=self.tabWidgetPage3)
        self.save_button.setObjectName("save_button")
        self.horizontalLayout_6.addWidget(self.save_button)
        self.remove_button = QtWidgets.QPushButton(parent=self.tabWidgetPage3)
        ...
        self.xlabel_24 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        ...
        self.search_mode = QtWidgets.QComboBox(parent=self.tabWidgetPage3)
        ...
        self.xlabel_21 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.xlabel_21.setObjectName("xlabel_21")
        self.vargrid.addWidget(self.xlabel_21, 5, 0, 1, 1)
        self.search_field = QtWidgets.QComboBox(parent=self.tabWidgetPage3)
        self.search_field.setObjectName("search_field")
        self.vargrid.addWidget(self.search_field, 5, 1, 1, 1)
        self.s_r_src_ident_label = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.s_r_src_ident_label.setObjectName("s_r_src_ident_label")
        self.vargrid.addWidget(self.s_r_src_ident_label, 6, 0, 1, 1)
        self.s_r_src_ident = QtWidgets.QComboBox(parent=self.tabWidgetPage3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        self.template_label = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        ...
        self.xlabel_2 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.xlabel_2.setObjectName("xlabel_2")
        self.vargrid.addWidget(self.xlabel_2, 7, 0, 1, 1)
        self.search_for = HistoryLineEdit(parent=self.tabWidgetPage3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(100)
        sizePolicy.setVerticalStretch(0)
        ...
        self.case_sensitive = QtWidgets.QCheckBox(parent=self.tabWidgetPage3)
        ...
        self.xlabel_4 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.xlabel_4.setObjectName("xlabel_4")
        self.vargrid.addWidget(self.xlabel_4, 8, 0, 1, 1)
        self.replace_with = HistoryLineEdit(parent=self.tabWidgetPage3)
        ...
        self.label_41 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.label_41.setObjectName("label_41")
        self.verticalLayout.addWidget(self.label_41)
        self.replace_func = QtWidgets.QComboBox(parent=self.tabWidgetPage3)
        ...
        self.destination_field_label = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        ...
        self.destination_field = QtWidgets.QComboBox(parent=self.tabWidgetPage3)
        ...
        self.s_r_dst_ident_label = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.s_r_dst_ident_label.setObjectName("s_r_dst_ident_label")
        self.vargrid.addWidget(self.s_r_dst_ident_label, 10, 0, 1, 1)
        self.s_r_dst_ident = QtWidgets.QLineEdit(parent=self.tabWidgetPage3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(100)
        sizePolicy.setVerticalStretch(0)
        ...
        self.xlabel_412 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.xlabel_412.setObjectName("xlabel_412")
        self.horizontalLayout_21.addWidget(self.xlabel_412)
        self.results_count = QtWidgets.QSpinBox(parent=self.tabWidgetPage3)
        ...
        self.xlabel_413 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.xlabel_413.setObjectName("xlabel_413")
        self.horizontalLayout_21.addWidget(self.xlabel_413)
        self.starting_from = QtWidgets.QSpinBox(parent=self.tabWidgetPage3)
        ...
        self.xlabel_41 = QtWidgets.QLabel(parent=self.tabWidgetPage3)
        self.xlabel_41.setObjectName("xlabel_41")
        self.horizontalLayout_21.addWidget(self.xlabel_41)
        self.multiple_separator = QtWidgets.QLineEdit(parent=self.tabWidgetPage3)
        ...
        self.scrollArea11 = QtWidgets.QScrollArea(parent=self.tabWidgetPage3)
        ...
        self.test_text = HistoryLineEdit(parent=self.gridLayoutWidget_2)
        self.test_text.setObjectName("test_text")
        self.testgrid.addWidget(self.test_text, 8, 1, 1, 1)
        self.test_result = QtWidgets.QLineEdit(parent=self.gridLayoutWidget_2)
        ...
        self.transform_tab.setObjectName("transform_tab")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.transform_tab)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.label_5 = QtWidgets.QLabel(parent=self.transform_tab)
        self.label_5.setWordWrap(True)
        self.label_5.setObjectName("label_5")
        self.verticalLayout_5.addWidget(self.label_5)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.button_transform_tags = QtWidgets.QPushButton(parent=self.transform_tab)
        self.button_transform_tags.setObjectName("button_transform_tags")
        self.horizontalLayout_7.addWidget(self.button_transform_tags)
        self.label_transform_tags = QtWidgets.QLabel(parent=self.transform_tab)
        self.label_transform_tags.setObjectName("label_transform_tags")
        self.horizontalLayout_7.addWidget(self.label_transform_tags)
        self.button_clear_tags_rules = QtWidgets.QToolButton(parent=self.transform_tab)
        self.button_clear_tags_rules.setObjectName("button_clear_tags_rules")
        self.horizontalLayout_7.addWidget(self.button_clear_tags_rules)
        spacerItem12 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem12)
        self.verticalLayout_5.addLayout(self.horizontalLayout_7)
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.button_transform_authors = QtWidgets.QPushButton(parent=self.transform_tab)
        self.button_transform_authors.setObjectName("button_transform_authors")
        self.horizontalLayout_11.addWidget(self.button_transform_authors)
        self.label_transform_authors = QtWidgets.QLabel(parent=self.transform_tab)
        self.label_transform_authors.setObjectName("label_transform_authors")
        self.horizontalLayout_11.addWidget(self.label_transform_authors)
        self.button_clear_authors_rules = QtWidgets.QToolButton(parent=self.transform_tab)
        self.button_clear_authors_rules.setObjectName("button_clear_authors_rules")
        self.horizontalLayout_11.addWidget(self.button_clear_authors_rules)
        spacerItem13 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_11.addItem(spacerItem13)
        self.verticalLayout_5.addLayout(self.horizontalLayout_11)
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.button_transform_publishers = QtWidgets.QPushButton(parent=self.transform_tab)
        self.button_transform_publishers.setObjectName("button_transform_publishers")
        self.horizontalLayout_8.addWidget(self.button_transform_publishers)
        self.label_transform_publishers = QtWidgets.QLabel(parent=self.transform_tab)
        self.label_transform_publishers.setObjectName("label_transform_publishers")
        self.horizontalLayout_8.addWidget(self.label_transform_publishers)
        self.button_clear_publishers_rules = QtWidgets.QToolButton(parent=self.transform_tab)
        self.button_clear_publishers_rules.setObjectName("button_clear_publishers_rules")
        self.horizontalLayout_8.addWidget(self.button_clear_publishers_rules)
        ...
        self.central_widget.addTab(self.transform_tab, "")
        self.verticalLayout_3.addWidget(self.central_widget)
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.refresh_book_list = QtWidgets.QCheckBox(parent=MetadataBulkDialog)
        ...
        self.button_box = QtWidgets.QDialogButtonBox(parent=MetadataBulkDialog)
...
"              the result of the search/replace.</p>"))
        ...
        self.label_5.setText(_("Create rules to transform metadata by clicking the buttons below. The rules will be applied to all selected books when you click OK."))
        self.button_transform_tags.setText(_("Transform &tags"))
        self.button_clear_tags_rules.setText(_("..."))
        self.button_transform_authors.setText(_("Transform &authors"))
        self.button_clear_authors_rules.setText(_("..."))
        self.button_transform_publishers.setText(_("Transform &publishers"))
        self.button_clear_publishers_rules.setText(_("..."))
        self.central_widget.setTabText(self.central_widget.indexOf(self.transform_tab), _("&Transform tags/authors"))
