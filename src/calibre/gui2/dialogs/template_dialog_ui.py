# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\dialogs\template_dialog.ui'
#
...
class Ui_TemplateDialog(object):
    def setupUi(self, TemplateDialog):
        ...
        self.scroll_area = QtWidgets.QScrollArea(parent=TemplateDialog)
        ...
        self.icon_layout = QtWidgets.QWidget(parent=self.wid1)
        ...
        self.icon_kind_label = QtWidgets.QLabel(parent=self.icon_layout)
        self.icon_kind_label.setObjectName("icon_kind_label")
        self.icon_kind_layout.addWidget(self.icon_kind_label)
        self.icon_kind = QtWidgets.QComboBox(parent=self.icon_layout)
        ...
        self.filename_button = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.template_name_label = QtWidgets.QLabel(parent=self.wid1)
        self.template_name_label.setObjectName("template_name_label")
        self.hboxlayout.addWidget(self.template_name_label)
        self.template_name = QtWidgets.QComboBox(parent=self.wid1)
        ...
        self.label = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.eparator1 = Separator(parent=self.wid1)
        self.eparator1.setObjectName("eparator1")
        self.lowlayout.addWidget(self.eparator1)
        self.breakpoint_line_box_label = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.breakpoint_line_box = QtWidgets.QSpinBox(parent=self.wid1)
        ...
        self.toggle_button = QtWidgets.QToolButton(parent=self.wid1)
        ...
        self.eparator2 = Separator(parent=self.wid1)
        self.eparator2.setObjectName("eparator2")
        self.lowlayout.addWidget(self.eparator2)
        self.remove_all_button = QtWidgets.QToolButton(parent=self.wid1)
        ...
        self.set_all_button = QtWidgets.QToolButton(parent=self.wid1)
        ...
        self.textbox = CodeEditor(parent=self.wid1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.new_doc_label = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.new_doc = QtWidgets.QTextEdit(parent=self.wid1)
        self.new_doc.setObjectName("new_doc")
        self.gridLayout.addWidget(self.new_doc, 4, 0, 1, 3)
        self.label2 = QtWidgets.QLabel(parent=self.wid1)
        self.label2.setObjectName("label2")
        self.gridLayout.addWidget(self.label2, 7, 0, 1, 1)
        self.template_value = QtWidgets.QTableWidget(parent=self.wid1)
        ...
        self.user_label_1 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_2 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_3 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_4 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_5 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_6 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_7 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_8 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.user_label_9 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=self.wid1)
        ...
        self.frame2 = QtWidgets.QFrame(parent=self.wid1)
        ...
        self.label3 = QtWidgets.QLabel(parent=self.wid1)
        self.label3.setObjectName("label3")
        self.gridlayout2.addWidget(self.label3, 0, 0, 1, 2)
        self.label4 = QtWidgets.QLabel(parent=self.wid1)
        self.label4.setObjectName("label4")
        self.gridlayout2.addWidget(self.label4, 1, 0, 1, 1)
        self.function = QtWidgets.QComboBox(parent=self.wid1)
        self.function.setObjectName("function")
        self.gridlayout2.addWidget(self.function, 1, 1, 1, 1)
        self.label_22 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.documentation = QtWidgets.QPlainTextEdit(parent=self.wid1)
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.source_code = QtWidgets.QPlainTextEdit(parent=self.wid1)
        ...
        self.template_tutorial = QtWidgets.QLabel(parent=self.wid1)
        ...
        self.template_func_reference = QtWidgets.QLabel(parent=self.wid1)
