# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\dialogs\smartdevice.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ip_addresses = QtWidgets.QLabel(parent=Dialog)
        ...
        self.password_box = QtWidgets.QLineEdit(parent=Dialog)
        ...
        self.show_password = QtWidgets.QCheckBox(parent=Dialog)
        ...
        self.fixed_port = QtWidgets.QLineEdit(parent=Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(100)
        sizePolicy.setVerticalStretch(0)
        ...
        self.use_fixed_port = QtWidgets.QCheckBox(parent=Dialog)
        self.use_fixed_port.setObjectName("use_fixed_port")
        self.gridlayout.addWidget(self.use_fixed_port, 4, 2, 1, 1)
        self.autostart_box = QtWidgets.QCheckBox(parent=Dialog)
