# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\dialogs\tag_categories.ui'
#
...
class Ui_TagCategories(object):
    def setupUi(self, TagCategories):
        ...
        self.label_3 = QtWidgets.QLabel(parent=TagCategories)
        ...
        self.category_box = QtWidgets.QComboBox(parent=TagCategories)
        ...
        self.copy_category_name_to_clipboard = QtWidgets.QToolButton(parent=TagCategories)
        ...
        self.label_5 = QtWidgets.QLabel(parent=TagCategories)
        ...
        self.category_filter_box = QtWidgets.QComboBox(parent=TagCategories)
        ...
        self.label_filt = QtWidgets.QLabel(parent=TagCategories)
        ...
        self.item_filter_box = QtWidgets.QLineEdit(parent=TagCategories)
        ...
        self.delete_category_button = QtWidgets.QToolButton(parent=TagCategories)
        ...
        self.input_box = QtWidgets.QLineEdit(parent=TagCategories)
        self.input_box.setClearButtonEnabled(True)
        self.input_box.setObjectName("input_box")
        self.hboxlayout.addWidget(self.input_box)
        self.add_category_button = QtWidgets.QToolButton(parent=TagCategories)
        ...
        self.rename_category_button = QtWidgets.QToolButton(parent=TagCategories)
        ...
        self.apply_vl_checkbox = QtWidgets.QCheckBox(parent=TagCategories)
        self.apply_vl_checkbox.setObjectName("apply_vl_checkbox")
        self.gridLayout.addWidget(self.apply_vl_checkbox, 1, 0, 1, 3)
        self.hide_hidden_categories_checkbox = QtWidgets.QCheckBox(parent=TagCategories)
        ...
        self.label = QtWidgets.QLabel(parent=TagCategories)
        self.label.setObjectName("label")
        self.gridLayout_2.addWidget(self.label, 1, 0, 1, 1)
        self.available_items_box = QtWidgets.QListWidget(parent=TagCategories)
        ...
        self.apply_button = QtWidgets.QToolButton(parent=TagCategories)
        ...
        self.label_2 = QtWidgets.QLabel(parent=TagCategories)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 1, 2, 1, 1)
        self.applied_items_box = QtWidgets.QListWidget(parent=TagCategories)
        ...
        self.unapply_button = QtWidgets.QToolButton(parent=TagCategories)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=TagCategories)
