# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\dialogs\match_books.ui'
#
...
class Ui_MatchBooks(object):
    def setupUi(self, MatchBooks):
        ...
        self.search_text = HistoryLineEdit(parent=MatchBooks)
        ...
        self.search_button = QtWidgets.QPushButton(parent=MatchBooks)
        self.search_button.setObjectName("search_button")
        self.gridlayout.addWidget(self.search_button, 0, 1, 1, 1)
        self.label = QtWidgets.QLabel(parent=MatchBooks)
        self.label.setObjectName("label")
        self.gridlayout.addWidget(self.label, 1, 0, 1, 2)
        self.books_table = QtWidgets.QTableWidget(parent=MatchBooks)
        ...
        self.label1 = QtWidgets.QLabel(parent=MatchBooks)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=MatchBooks)
