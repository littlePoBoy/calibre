# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\dialogs\delete_matching_from_device.ui'
#
...
class Ui_DeleteMatchingFromDeviceDialog(object):
    def setupUi(self, DeleteMatchingFromDeviceDialog):
        ...
        self.explanation = QtWidgets.QLabel(parent=DeleteMatchingFromDeviceDialog)
        self.explanation.setObjectName("explanation")
        self.verticalLayout.addWidget(self.explanation)
        self.table = QtWidgets.QTableWidget(parent=DeleteMatchingFromDeviceDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DeleteMatchingFromDeviceDialog)
