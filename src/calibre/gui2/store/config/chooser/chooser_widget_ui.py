# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\store\config\chooser\chooser_widget.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.query = HistoryLineEdit(parent=Form)
