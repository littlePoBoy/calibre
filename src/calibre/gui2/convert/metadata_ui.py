# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\metadata.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cover_path = QtWidgets.QLineEdit(parent=self.groupBox_4)
        self.cover_path.setClearButtonEnabled(True)
        self.cover_path.setObjectName("cover_path")
        self._5.addWidget(self.cover_path)
        self.cover_button = QtWidgets.QToolButton(parent=self.groupBox_4)
        ...
        self.opt_prefer_metadata_cover = QtWidgets.QCheckBox(parent=self.groupBox_4)
        ...
        self.cover = ImageView(parent=self.groupBox_4)
        ...
        self.title = EnLineEdit(parent=Form)
        ...
        self.author_sort = EnLineEdit(parent=Form)
        ...
        self.tags = EditWithComplete(parent=Form)
        ...
        self.series = EditWithComplete(parent=Form)
        ...
        self.series_index = QtWidgets.QDoubleSpinBox(parent=Form)
