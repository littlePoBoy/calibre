# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\docx_input.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_docx_no_cover = QtWidgets.QCheckBox(parent=Form)
        self.opt_docx_no_cover.setObjectName("opt_docx_no_cover")
        self.verticalLayout_3.addWidget(self.opt_docx_no_cover)
        self.opt_docx_no_pagebreaks_between_notes = QtWidgets.QCheckBox(parent=Form)
        ...
        self.opt_docx_inline_subsup = QtWidgets.QCheckBox(parent=Form)
