# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\comic_input.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_colors = QtWidgets.QSpinBox(parent=Form)
        ...
        self.opt_dont_normalize = QtWidgets.QCheckBox(parent=Form)
        self.opt_dont_normalize.setObjectName("opt_dont_normalize")
        self.gridLayout.addWidget(self.opt_dont_normalize, 5, 0, 1, 1)
        self.opt_keep_aspect_ratio = QtWidgets.QCheckBox(parent=Form)
        ...
        self.opt_no_process = QtWidgets.QCheckBox(parent=Form)
        ...
        self.opt_dont_grayscale = QtWidgets.QCheckBox(parent=Form)
        ...
        self.opt_comic_image_size = QtWidgets.QLineEdit(parent=Form)
        ...
        self.opt_dont_add_comic_pages_to_toc = QtWidgets.QCheckBox(parent=Form)
