# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\xpath_wizard.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tag = QtWidgets.QComboBox(parent=Form)
        ...
        self.attribute = QtWidgets.QLineEdit(parent=Form)
        ...
        self.value = QtWidgets.QLineEdit(parent=Form)
        self.value.setClearButtonEnabled(True)
        self.value.setObjectName("value")
        self.verticalLayout.addWidget(self.value)
        self.example_label = QtWidgets.QLabel(parent=Form)
