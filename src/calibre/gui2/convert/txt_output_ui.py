# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\txt_output.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_txt_output_encoding = EncodingComboBox(parent=self.groupBox)
        ...
        self.opt_newline = QtWidgets.QComboBox(parent=self.groupBox)
        self.opt_newline.setObjectName("opt_newline")
        self.gridLayout.addWidget(self.opt_newline, 1, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=self.groupBox)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 2, 0, 1, 1)
        self.opt_txt_output_formatting = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.opt_max_line_length = QtWidgets.QSpinBox(parent=self.groupBox_2)
        self.opt_max_line_length.setObjectName("opt_max_line_length")
        self.gridLayout_2.addWidget(self.opt_max_line_length, 1, 1, 1, 1)
        self.opt_force_max_line_length = QtWidgets.QCheckBox(parent=self.groupBox_2)
        ...
        self.opt_inline_toc = QtWidgets.QCheckBox(parent=self.groupBox_2)
        ...
        self.opt_keep_links = QtWidgets.QCheckBox(parent=self.groupBox_3)
        self.opt_keep_links.setObjectName("opt_keep_links")
        self.verticalLayout.addWidget(self.opt_keep_links)
        self.opt_keep_image_references = QtWidgets.QCheckBox(parent=self.groupBox_3)
        ...
        self.opt_keep_color = QtWidgets.QCheckBox(parent=self.groupBox_3)
        self.opt_keep_color.setObjectName("opt_keep_color")
        self.verticalLayout.addWidget(self.opt_keep_color)
        self.image_note_label = QtWidgets.QLabel(parent=self.groupBox_3)
        self.image_note_label.setWordWrap(True)
        self.image_note_label.setObjectName("image_note_label")
        self.verticalLayout.addWidget(self.image_note_label)
    ...
    def retranslateUi(self, Form):
        ...
        self.image_note_label.setText(_("Note that images will not be preserved. For that, convert to TXTZ, with the Output format set to markdown."))
