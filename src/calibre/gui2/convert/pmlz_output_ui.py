# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\pmlz_output.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.opt_inline_toc = QtWidgets.QCheckBox(parent=Form)
        self.opt_inline_toc.setObjectName("opt_inline_toc")
        self.gridLayout.addWidget(self.opt_inline_toc, 2, 0, 1, 1)
        self.opt_full_image_depth = QtWidgets.QCheckBox(parent=Form)
        ...
        self.opt_pml_output_encoding = EncodingComboBox(parent=Form)
