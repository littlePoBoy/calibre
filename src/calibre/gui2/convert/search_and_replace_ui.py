# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\search_and_replace.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.sr_search = RegexEdit(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sr_replace = QtWidgets.QLineEdit(parent=self.groupBox)
        ...
        self.sr_load = QtWidgets.QPushButton(parent=Form)
        self.sr_load.setObjectName("sr_load")
        self.buttonsLayout.addWidget(self.sr_load)
        self.sr_save = QtWidgets.QPushButton(parent=Form)
        ...
        self.search_replace = QtWidgets.QTableWidget(parent=Form)
        ...
        self.sr_up = QtWidgets.QPushButton(parent=Form)
        ...
        self.sr_down = QtWidgets.QPushButton(parent=Form)
        ...
        self.rh_label = QtWidgets.QLabel(parent=Form)
