# Form implementation generated from reading ui file 'D:\pyprojects\calibre\src\calibre\gui2\convert\heuristics.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.help_label = QtWidgets.QLabel(parent=Form)
        ...
        self.opt_unwrap_lines = QtWidgets.QCheckBox(parent=self.heuristic_options)
        ...
        self.huf_label = QtWidgets.QLabel(parent=self.heuristic_options)
        self.huf_label.setObjectName("huf_label")
        self.horizontalLayout.addWidget(self.huf_label)
        self.opt_html_unwrap_factor = QtWidgets.QDoubleSpinBox(parent=self.heuristic_options)
        ...
        self.opt_markup_chapter_headings = QtWidgets.QCheckBox(parent=self.heuristic_options)
        ...
        self.opt_renumber_headings = QtWidgets.QCheckBox(parent=self.heuristic_options)
        self.opt_renumber_headings.setObjectName("opt_renumber_headings")
        self.verticalLayout_2.addWidget(self.opt_renumber_headings)
        self.opt_delete_blank_paragraphs = QtWidgets.QCheckBox(parent=self.heuristic_options)
        ...
        self.opt_format_scene_breaks = QtWidgets.QCheckBox(parent=self.heuristic_options)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.heuristic_options)
        ...
        self.opt_replace_scene_breaks = QtWidgets.QComboBox(parent=self.heuristic_options)
        ...
        self.opt_dehyphenate = QtWidgets.QCheckBox(parent=self.heuristic_options)
        self.opt_dehyphenate.setObjectName("opt_dehyphenate")
        self.verticalLayout_2.addWidget(self.opt_dehyphenate)
        self.opt_italicize_common_cases = QtWidgets.QCheckBox(parent=self.heuristic_options)
        ...
        self.opt_fix_indents = QtWidgets.QCheckBox(parent=self.heuristic_options)
